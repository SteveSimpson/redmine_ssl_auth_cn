...
* Install the plugin: ruby script/plugin install git://github.com/SteveSimpson/redmine_ssl_auth.git
* Configure apache for SSL authentication (see Configuration)
* Visit https://YOURSITE/login and it will login automatically

== Notes 

* This plugin expects the CN of the certificate to be your username 
* A user with that username should exist in the database
...
This is not up to date, I will update later.... (Steve)
