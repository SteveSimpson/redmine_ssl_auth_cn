...
* This plugin expects the CN of the certificate to be your username, & CN must be unique
...
=== Plugin Installation
I can't really comment here. I checked out my code in: redmine/plugins/ and restarted apache.

What Upstream said didn't work for me:
         ruby script/plugin install git://github.com/koke/redmine_ssl_auth.git
...
(I haven't reviewed it myself. But there is a lot of good information.)
